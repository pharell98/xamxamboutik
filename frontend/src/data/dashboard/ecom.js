...
export const notifications = [
  ...
  {
    id: 2,
    title: '<strong>7 supply</strong> have payments that need to be captured',
    linkFor: 'payments'
  },
  {
    id: 3,
    title: '<strong>50+ supply</strong> need to be fulfilled',
    linkFor: 'orders'
  }
];
...
export const saleItems = [
  ...
  {
    title: 'Montant Caisse Fermeture',
    amount: '-',
    className:
