    ...
    switch (type) {
      ...
      case 'NEXT_PAGE': {
        ...
        return {
          ...
          canNextPage: state.totalPage > nextPageIndex,
          canPreviousPage: state.totalPage > 1,
          from: setFrom(state.itemsPerPage, nextPageIndex),
          to: setTo(state.itemsPerPage, nextPageIndex, data.length)
        };
      }
      case 'PREVIOUS_PAGE': {
        ...
        return {
          ...
          canPreviousPage: prevPageIndex > 1,
          from: setFrom(state.itemsPerPage, prevPageIndex),
          to: setTo(state.itemsPerPage, prevPageIndex, data.length)
        };
      }
      case 'GO_TO_PAGE': {
